...
pipeline {
    ...
    environment {
        ...
        DOCKER_CONTAINER    = "ci-cd-demo2-html-css-app"               // nom du conteneur
        DOCKER_CREDENTIALS  = credentials("devops1") // identifiants Docker Hub
    }
    ...
    stages {
        ...
        stage("Checkout") {
            steps {
                git branch: 'master', url: 'https://github.com/papecode/ci-cd-demo2-html-css.git'
            }
        }
